...
class AbstractModel(ModelBase, Tunable):
    ...
    def __init__(
        ...
        self.path: str = self.create_contexts(self._get_model_path())
    ...
    def _get_model_path(self, path_root: str | None = None) -> str:
        if path_root is None:
            path_root = self.path_root
        return os.path.join(path_root, self.path_suffix)
